...
$products = ServiceData::getAudit();

// Set document properties
$objPHPExcel->getProperties()->setCreator("SySpa 3.0")
							 ->setLastModifiedBy("SySpa 3.0")
							 ->setTitle("Audit Services - SySpa 3.0")
							 ->setSubject("SySpa Audit Services Report")
							 ->setDescription("")
							 ->setKeywords("")
							 ->setCategory("");
...
$sheet->setCellValue('A1', 'Auditoria de Servicios - SySpa')
...
->setCellValue('H2', 'Codigo de barra')
->setCellValue('I2', 'Nombre')
->setCellValue('J2', 'Descripcion')
->setCellValue('K2', 'Precio Servicio')
->setCellValue('L2', 'Precio Operativo')
->setCellValue('M2', 'Comision')
->setCellValue('N2', 'Precio Venta')
->setCellValue('O2', 'Categoria')
->setCellValue('P2', 'Presentacion')
->setCellValue('Q2', 'Duracion')
...
->setCellValue('K'.$start, $product->service_price)
->setCellValue('L'.$start, $product->operating_price)
->setCellValue('M'.$start, $product->commision)
->setCellValue('N'.$start, $product->total)
->setCellValue('O'.$start, $product->getCategory()->name)
->setCellValue('P'.$start, $product->presentation)
->setCellValue('Q'.$start, $product->duration." min.")
->setCellValue('R'.$start, $product->status_dsc);
$start++;
}
...
header('Content-Disposition: attachment;filename="auditservices-'.time().'.xlsx"');
