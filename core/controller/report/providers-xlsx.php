...
$objPHPExcel->getProperties()->setCreator("SySpa 3.0")
							 ...
							 ->setTitle("Providers - SySpa 3.0")
							 ->setSubject("SySpa Providers Report")
							 ->setDescription("")
							 ->setKeywords("")
							 ->setCategory("");
...
$sheet->setCellValue('A1', 'Reporte de Proveedores - SySpa')
->setCellValue('A2', 'Cédula/RNC')
->setCellValue('B2', 'Nombre')
->setCellValue('C2', 'Contacto')
->setCellValue('D2', 'Dirección')
...
->setCellValue('B'.$start, $user->name)
->setCellValue('C'.$start, $user->lastname)
->setCellValue('D'.$start, $user->address1)
->setCellValue('E'.$start, $user->email1)
->setCellValue('F'.$start, $user->phone1)
->setCellValue('G'.$start, $sdata->description);
$start++;
}
