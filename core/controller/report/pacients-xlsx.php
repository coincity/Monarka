...
$objPHPExcel->getProperties()->setCreator("SySpa 3.0")
							 ...
							 ->setTitle("Pacients - SySpa 3.0")
							 ->setSubject("SySpa Pacients Report")
							 ->setDescription("")
							 ->setKeywords("")
							 ->setCategory("");
...
$sheet->setCellValue('A1', 'Reporte de Pacientes - SySpa')
...
->setCellValue('B'.$start, $user->name." ".$user->lastname)
->setCellValue('C'.$start, $user->address1)
...
header('Content-Disposition: attachment;filename="pacients-'.time().'.xlsx"');
