...
if(count($_POST)>0){
	...
	$rr = NCFData::getRepeated($_POST["tipo_doc"],$_POST["tipo"],DateTime::createFromFormat('d/m/Y', $_POST["fecinivig"])->format('Y-m-d'),DateTime::createFromFormat('d/m/Y', $_POST["fecfinvig"])->format('Y-m-d'));
