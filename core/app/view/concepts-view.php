        ...
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p>Mantenimiento de los Diferentes Conceptos de Gastos y Costos</p>
                </div>
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page">Conceptos</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="widget-wrap">
                    <div class="widget-header block-header clearfix">
                        <h3>CONSULTA DE CONCEPTOS DE GASTOS</h3>
                        <div class="data-align-right">
                            <a href="./index.php?view=newconcept" class="btn add-row btn-primary">Nuevo Concepto</a>
                        </div>
                    </div>
    ...
    $(document).ready(function(){
        if ($.fn.dataTable) {
            $('.data-tbl2').DataTable({
                ...
                "stateSave": true,
                "ajax":{
                    url :"./?action=dtgetconcepts", // json datasource
                    type: "post"
                },
                "columns": [
                    {
                        ...
                        "render" : function ( data, type, full) {
                           return '<a href="index.php?view=detailconcept&id=+'+data+'" class="btn-default" data-toggle="tooltip" title="Ver Detalle"><i class="zmdi zmdi-eye"></i></a>';
                        }
                    },
					{ "data": "description" },
                    {
                    ...
                    },
                    {
                        ...
                        "render" : function ( data, type, full) {
                            ...
                            result = result + '<a href="index.php?view=editconcept&id='+full['id']+'" class="btn btn-default btn-sm m-user-edit" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>';
