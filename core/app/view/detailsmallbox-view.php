                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group iconic-input">
                                                    ...
                                                    <input type="text" disabled name="date_at" class="form-control date_at" id="date_at" value="<?php echo date("d/m/Y",strtotime($smallbox->date_at));?>" placeholder="Fecha de Operacion" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group iconic-input">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo $smallbox->description;?>" id="description" name="description" placeholder="Descripción" disabled />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group iconic-input">
                                                    ...
                                                    <input type="number" class="form-control" value="<?php echo $smallbox->amount;?>" id="amount" name="amount" placeholder="Monto" disabled />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-actions">
                                                    <a href="./index.php?view=smallbox" type="button" class="btn btn-default">Volver a la Consulta</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
