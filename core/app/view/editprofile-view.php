            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        <li class="active-page">Inicio <i class="zmdi zmdi-chevron-right"></i></li>
                        <li class="active-page">Usuarios <i class="zmdi zmdi-chevron-right"></i></li>
                ...
                <div class="widget-wrap">
                    ...
                    <div class="widget-container">
                        <div class="widget-content">
                            <div class="row">
                                <div class="col-md-7">
                                    <form class="form-horizontal j-forms" method="post" id="edituser" enctype="multipart/form-data" action="index.php?action=updateprofile" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-actions">
                                                    ...
                                                    <a href="./?view=home" type="button" class="btn btn-default">Cancelar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
