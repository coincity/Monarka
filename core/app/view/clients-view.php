            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page">Clientes</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="widget-wrap">
                    <div class="widget-header block-header clearfix">
                        ...
                        <div class="data-align-right">
                            <a href="./index.php?view=newclient" class="btn add-row btn-primary">Nuevo Cliente</a>
                        </div>
                    </div>
    ...
    $(document).ready(function(){
        if ($.fn.dataTable) {
            $('.data-tbl').DataTable({
                ...
                "stateSave": true,
                "ajax":{
                    url :"./?action=dtgetclients", // json datasource
                    type: "post"
                },
                "columns": [
                    {
                        ...
                        "render" : function ( data, type, full) {
                           return '<a href="index.php?view=detailclient&id=+'+data+'" class="btn-default" data-toggle="tooltip" title="Ver Detalle"><i class="zmdi zmdi-eye"></i></a>';
                        }
                    },
					{
                        "data": "image",
                        "render" : function ( url, type, full) {
                            return '<img class="img-rounded" style="width:34px;" src="storage/clients/'+url+'"/>';
                        }
                    },
                    { "data": "name" },
                    { "data": "lastname" },
                    ...
                    },
                    {
                        ...
                        "render" : function ( data, type, full) {
                            ...
                            result = result + '<a href="index.php?view=editclient&id='+full['id']+'" class="btn btn-default btn-sm m-user-edit" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>';
