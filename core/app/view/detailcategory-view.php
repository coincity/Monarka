										...
										<div class="form-group" style="display:none;">
											...
											<div class="col-md-7">
												<div class="input-group iconic-input">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo $category->id;?>" placeholder="00" disabled />
												</div>
											</div>
										</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group iconic-input">
                                                    ...
                                                    <input type="text" class="form-control" id="prefix" name="prefix" value="<?php echo $category->prefix;?>" placeholder="Prefijo" disabled />
                                                </div>
                                            </div>
                                        </div>
										<div class="form-group">
											...
											<div class="col-md-7">
												<div class="input-group iconic-input">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo $category->description;?>" placeholder="Descripción" disabled />
												</div>
											</div>
										</div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-actions">
                                                    <a href="./index.php?view=categories" type="button" class="btn btn-default">Volver a la Consulta</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
