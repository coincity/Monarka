...
<section class="main-container">
    <div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    <h2>AGREGAR NUEVO CONCEPTO DE GASTO</h2>
                </div>
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        <li><a href="./index.php?view=home">Inicio <i class="zmdi zmdi-chevron-right"></i></a></li>
                        <li><a href="./index.php?view=concepts">Conceptos de Gastos <i class="zmdi zmdi-chevron-right"></i></a></li>
                        <li class="active-page"> Nueva Gasto</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="widget-wrap">
                    ...
                    <div class="widget-container">
                        <div class="widget-content">
                            <div class="row">
                                <div class="col-md-7">
                                    <form class="form-horizontal j-forms" id="addconcept" method="post" action="index.php?action=addconcept" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-actions">
                                                    ...
                                                    <a href="./index.php?view=concepts" type="button" class="btn btn-default">Cancelar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
