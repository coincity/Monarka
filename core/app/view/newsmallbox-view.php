            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page"> Nueva Operacion</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="widget-wrap">
                    ...
                    <div class="widget-container">
                        <div class="widget-content">
                            <div class="row">
                                <div class="col-md-7">
                                    <form class="form-horizontal j-forms" id="addsmallbox" method="post" action="index.php?action=addsmallbox" role="form">                              
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group iconic-input">
                                                    ...
                                                    <input type="text" name="date_at" class="form-control date_at" id="date_at" placeholder="Fecha de Operacion" required>
                                                </div>
                                            </div>
                                        </div>
										<div class="form-group">
