    ...
    <div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-6">
                    <h2>Servicios</h2>
                    <p>Mantenimiento de los Servicios a Ofrecer</p>
                </div>
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page">Servicios</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="widget-wrap">
                    <div class="widget-header block-header clearfix">
                        ...
                        <div class="data-align-right">
                            <a href="./index.php?view=newservice" class="btn add-row btn-primary">Nuevo Servicio</a>
                        </div>
                    </div>
    ...
    $(document).ready(function(){
        ...
        if ($.fn.dataTable) {
            $('.data-tbl').DataTable({
                ...
                "stateSave": true,
                "ajax":{
                    url :"./?action=dtgetservices", // json datasource
                    type: "post"
                },
                "columns": [
                    {
                        ...
                        "render" : function ( data, type, full) {
                           return '<a href="index.php?view=detailservice&id=+'+data+'" class="btn-default" data-toggle="tooltip" title="Ver Detalle"><i class="zmdi zmdi-eye"></i></a>';
                        }
                    },
					{
                        "data": "image",
                        "render" : function ( url, type, full) {
                            return '<img class="img-rounded" style="width:34px;" src="storage/services/'+url+'"/>';
                        }
					},
					{ "data": "category" },
					{ "data": "barcode" },
                    ...
                    },
                    {
                        ...
                        "render" : function ( data, type, full) {
                            ...
                            result = result + '<a href="index.php?view=editservice&id='+full['id']+'" class="btn btn-default btn-sm m-user-edit" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>';
        ...
        $(document).on('click', '.m-user-delete', function () {
            var url = 'index.php?action=cambiarstatus&table=services&id=' + $(this).data('id') + '&status_id=' + $(this).data('status');
            var obj;
            $.ajax({
                type: "POST",
                url: url,
