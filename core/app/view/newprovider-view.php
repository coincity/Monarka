            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page"> Nuevo Proveedor</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="widget-wrap">
                    ...
                    <div class="widget-container">
                        <div class="widget-content">
                            <div class="row">
                                <div class="col-md-7">
                                    <form class="form-horizontal j-forms" id="addprovider" method="post" action="index.php?action=addprovider" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group iconic-input">
                                                    ...
                                                    <input type="text" class="form-control" id="no" name="no" placeholder="Cédula/RNC" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group iconic-input">
                                                    ...
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Nombre Contacto" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group iconic-input">
                                                    ...
                                                    <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Apellido Contacto" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group iconic-input">
                                                    ...
                                                    <input type="text" class="form-control" id="address" name="address" placeholder="Dirección Empresa" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
