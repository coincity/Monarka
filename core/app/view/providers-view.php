            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page">Proveedores</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="widget-wrap">
                    <div class="widget-header block-header clearfix">
                        ...
                        <div class="data-align-right">
                            <a href="./index.php?view=newprovider" class="btn add-row btn-primary">Nuevo Proveedor</a>
                        </div>
                    </div>
    ...
    $(document).ready(function(){
        if ($.fn.dataTable) {
            $('.data-tbl').DataTable({
                ...
                "stateSave": true,
                "ajax": {
                    url: "./?action=dtgetproviders", // json datasource
                    type: "post"
                },
                "columns": [
                    {
                        ...
                        "render": function (data, type, full) {
                            return '<a href="index.php?view=detailprovider&id=+' + data + '" class="btn-default" data-toggle="tooltip" title="Ver Detalle"><i class="zmdi zmdi-eye"></i></a>';
                        }
                    },
                    { "data": "no" },
                    { "data": "company" },
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, full) {
                            ...
                            result = result + '<a href="index.php?view=editprovider&id=' + full['id'] + '" class="btn btn-default btn-sm m-user-edit" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>';
