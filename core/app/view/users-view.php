            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page">Usuarios</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="widget-wrap">
                <div class="widget-header block-header clearfix">
                    ...
                    <div class="data-align-right">
                        <a href="./?view=newuser" class="btn add-row btn-primary">Nuevo Usuario</a>
                    </div>
                </div>
                <div class="widget-container">
                    <div class="widget-content">
                        <table id="example" class="table cell-border data-tbl">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Foto</th>
    ...
    $(document).ready(function () {
        if ($.fn.dataTable) {
            $('.data-tbl').DataTable({
                ...
                "stateSave": true,
                "ajax": {
                    url: "./?action=dtgetusers", // json datasource
                    type: "post"
                },
                "columns": [
                    {
                        ...
                        "render": function (data, type, full) {
                            return '<a href="./?view=detailuser&id=' + data + '" class="btn-default" data-toggle="tooltip" title="Ver Detalle"><i class="zmdi zmdi-eye"></i></a>';
                        }
                    },
                    {
                        "data": "image",
                        "render": function (url, type, full) {
                            return '<img class="img-rounded" style="width:34px;" src="storage/profiles/' + url + '"/>';
                        }
                    },
                    {
                        "data": "name",
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, full) {
                            ...
                            result = result + '<a href="./?view=edituser&id=' + full['id'] + '" class="btn btn-default btn-sm m-user-edit" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>';
        ...
        $(document).on('click', '.m-user-delete', function () {
            var url = 'index.php?action=cambiarstatus&table=user&id=' + $(this).data('id') + '&status_id=' + $(this).data('status');
            //  alert("url: " + url);
            var obj;
            $.ajax({
                type: "POST",
