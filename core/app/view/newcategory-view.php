            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-page-breadcrumb">
                        ...
                        <li class="active-page"> Nueva Categoría</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="widget-wrap">
                    ...
                    <div class="widget-container">
                        <div class="widget-content">
                            <div class="row">
                                <div class="col-md-7">
                                    <form class="form-horizontal j-forms" id="addcategory" method="post" role="form">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#addcategory").submit(function (e) {
            e.preventDefault();
            $.post("./index.php?action=addcategory", $("#addcategory").serialize(), function (data) {
