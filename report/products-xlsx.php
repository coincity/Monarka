...
$objPHPExcel->getProperties()->setCreator("SySpa 3.0")
							 ...
							 ->setTitle("Products - SySpa 3.0")
							 ->setSubject("SySpa Products Report")
							 ->setDescription("")
							 ->setKeywords("")
							 ->setCategory("");
...
$sheet->setCellValue('A1', 'Reporte de Productos - SySpa')
->setCellValue('A2', 'Codigo de barra')
->setCellValue('B2', 'Nombre')
->setCellValue('C2', 'Descripcion')
->setCellValue('D2', 'Precio Entrada')
...
->setCellValue('E'.$start, $product->total)
->setCellValue('F'.$start, $product->getCategory()->name)
->setCellValue('G'.$start, $product->expire_at)
->setCellValue('H'.$start, $product->status_dsc);
$start++;
}
