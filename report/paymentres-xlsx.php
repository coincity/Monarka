...
$products = SellData::getAllBySQL("where operation_type_id=1 and p_id = 4 and d_id in (1,2,3) order by created_at desc");
...
$sheet->setCellValue('A1', 'Compras - SySpa')
->setCellValue('A2', 'No. Factura')
->setCellValue('B2', 'Estado Pago')
->setCellValue('C2', 'Estado Entrega')
->setCellValue('D2', 'Total')
->setCellValue('E2', 'Almacen')
...
->setCellValue('E'.$start, $product->getStockTo()->name)
...
header('Content-Disposition: attachment;filename="paymentres-'.time().'.xlsx"');
